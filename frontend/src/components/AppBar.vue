  ...
  <v-app-bar app color="primary" dark>
    ...
    <div v-if="isAuth" class="align-center">
      ...
      <v-btn class="ml-2" text to="../views/tareas">
        <span class="hidden-sm-and-down">Agregar tarea</span>
        <v-icon class="hidden-sm-and-up">mdi-account-plus</v-icon>
      </v-btn>

      <v-btn class="ml-2" text to="../views/TareasU">
        <span class="hidden-sm-and-down">Tareas</span>
        <v-icon class="hidden-sm-and-up">mdi-account-plus</v-icon>
      </v-btn>

      <v-btn v-if="isAdmin" class="ml-2" text to="../views/ListaTareas">
        <span class="hidden-sm-and-down">Todas las tareas</span>
        <v-icon class="hidden-sm-and-up">mdi-account-plus</v-icon>
      </v-btn>
